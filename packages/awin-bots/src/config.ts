...
export const config = {
  ...
  awinSubgraph:
    process.env.awin_SUBGRAPH_URL ??
    'https://api.thegraph.com/subgraphs/name/awindao/awin-subgraph',
  ...
  awinTokenAddress:
    process.env.awin_TOKEN_ADDRESS ?? '0x9C8fF314C9Bc7F6e59A9d9225Fb22946427eDC03',
