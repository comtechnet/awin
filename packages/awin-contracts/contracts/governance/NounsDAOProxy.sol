...
/// @title The awin DAO proxy contract
...
// LICENSE
// awinDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// awinDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract awinDAOProxy is awinDAOProxyStorage, awinDAOEvents {
    constructor(
        address timelock_,
        address awin_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'awinDAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'awinDAOProxy::_setImplementation: invalid implementation address');
