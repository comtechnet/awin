import { Auction, AuctionHouseContractFunction } from '../../wrappers/awinAuction';
...
import { useAuctionMinBidIncPercentage } from '../../wrappers/awinAuction';
...
const Bid: React.FC<{
  ...
  const awinAuctionHouseContract = new awinAuctionHouseFactory().attach(
  ...
  const placeBidHandler = async () => {
    ...
    const contract = connectContractToSigner(awinAuctionHouseContract, undefined, library);
